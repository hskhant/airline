...
require_once('controller.php');
       ...
       class model{
          	   ...
          	   function getlogin($con,$data,$table)
          	  {
          	  ...
          	  function getsignup($con,$data,$table)
          	  {
          	  	    $username= $data['username'];
		     	  	$password = $data['password'];
		     	  	 $Mobile = $data['mobile'];
		     	 ...
		     	 $sql = "INSERT INTO $table (`user_name`, `email`, `mobile`, `address`, `password`,`added_on`, `updeted_on`) VALUES ('$username','$email','$Mobile','$Address','$password','$added_on','$updated_on')";
		     	  ...
		     	  }	else
		     	  {
                    ...
                    // echo "<script>alert('invalid username and password')</script>".$con->error($query);
		     	  } 
          	  }
                 function getupdate($con,$data,$table)
                 {
